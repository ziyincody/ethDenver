import { LocaleRouteDefinition } from 'next/dist/server/future/route-definitions/locale-route-definition';
import { LocaleRouteMatch } from 'next/dist/server/future/route-matches/locale-route-match';
...
export declare class LocaleRouteMatcher<D extends LocaleRouteDefinition = LocaleRouteDefinition> extends RouteMatcher<D> {
    ...
    test(pathname: string, options?: LocaleMatcherMatchOptions): {
        params?: import("next/dist/shared/lib/router/utils/route-matcher").Params | undefined;
    } | null;
}
